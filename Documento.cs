public class Documento
{
    ...
    //COSTRUTTORI
    public Documento(string titolo, string anno, string autore, string codice)
    {
        this.Titolo = titolo;
        this.Anno = anno;
        this.Autore = autore;
    ...
    public Documento(string titolo, string anno, string autore, string codice, string settore, int scaffale)
    {
        this.Titolo = titolo;
        this.Anno = anno;
        this.Autore = autore;
